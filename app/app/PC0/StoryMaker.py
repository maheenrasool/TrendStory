...
def build_writer_prompt(trend_chain,Language = "English", tone="Comedic", theme="Slice of Life", story_style="Analytical Essay"):
    ...
    tone_instructions = {
        "Comedic": "Infuse the piece with humor. Make light-hearted observations, jokes, and puns to entertain the reader. The tone should be light and fun.",
        "Sarcastic": "Use sarcasm and dry humor to convey a sense of irony or mocking. The tone should be slightly critical, but in a witty way.",
